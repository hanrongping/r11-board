...
int initLangAndFont(void) {
	...
	resData->mFont_SimSun60 = CreateLogFont("ttf", "fzcircle", "UTF-8",
	FONT_WEIGHT_BOOK, FONT_SLANT_ROMAN,
	FONT_FLIP_NIL, FONT_OTHER_AUTOSCALE,
...
int deinitFont(void) {
	...
	DestroyLogFont(resData->mFont_SimSun60);
...
PLOGFONT getLogFont(enum FontID id) {
	...
	case ID_FONT_SIMSUN_55:
		...
		break;
	case ID_FONT_SIMSUN_60:
                resData->mCurLogFont = resData->mFont_SimSun60;
                break;
